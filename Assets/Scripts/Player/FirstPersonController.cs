...
public class FirstPersonController : MonoBehaviour
{
    ...
    // Internal Variables
    // W sekcji Sprint Variables
    [SerializeField] public CanvasGroup sprintBarCG; 
    ...
    void Start()
    {
        ...
        if(crosshair)
        {
            ...
            crosshairObject.transform.localScale = new Vector3(crosshairSize, crosshairSize, crosshairSize);
        }
        else
        {
    ...
    private void Update()
    {
        ...
        if (enableCrouch)
        {
            // Dodano sprawdzenie isSprinting w warunkach
            ...
            else if(Input.GetKeyUp(crouchKey) && holdToCrouch && !isSprinting)
            {
                isCrouched = true;
                Crouch();
            }
    ...
    private void Crouch()
    {
        // Blokada kucania podczas sprintu
        if ((!isCrouched && isSprinting) || (isCrouched && isSprinting))
        {
            return;
        }
...
// Custom Editor
    ...
    public override void OnInspectorGUI()
    {
        ...
        EditorGUILayout.LabelField("", GUI.skin.horizontalSlider);
        GUILayout.Label("Crosshair", new GUIStyle(GUI.skin.label) { alignment = TextAnchor.MiddleCenter, fontStyle = FontStyle.Bold, fontSize = 13 }, GUILayout.ExpandWidth(true));
        ...
        { 
            ...
            EditorGUILayout.BeginHorizontal();
            EditorGUILayout.PrefixLabel(new GUIContent("Crosshair Object", "Image component for the crosshair."));
            ...
            fpc.crosshairSize = EditorGUILayout.Slider(new GUIContent("Crosshair Size", "Determines the size of the crosshair."), fpc.crosshairSize, 0.5f, 3f);
        ...
        if(fpc.useSprintBar)
        {
            ...
            // Dodane pola
            EditorGUILayout.BeginHorizontal();
            EditorGUILayout.PrefixLabel(new GUIContent("Sprint Bar Canvas Group", "CanvasGroup for sprint bar fading."));
